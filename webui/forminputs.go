...
func (stringInput) Template(i sebastion.Input, def, err string) templ.Component {
	return templates.StringInput(i, def, err)
}
...
func (intInput) Template(i sebastion.Input, def, err string) templ.Component {
	return templates.IntInput(i, def, err)
}
...
func (boolInput) Template(i sebastion.Input, def, err string) templ.Component {
	return templates.BoolInput(i, def, err)
}
...
func (multiStringInput) Template(i sebastion.Input, def, err string) templ.Component {
	return templates.MultiStringInput(i, def, err)
}
