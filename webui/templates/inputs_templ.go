...
func UpdateValidation(name, message string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		templBuffer, templIsBuffer := w.(*bytes.Buffer)
		if !templIsBuffer {
			templBuffer = new(bytes.Buffer)
		...
		_, err = templBuffer.WriteString(templ.EscapeString(fmt.Sprintf("#%s>#validation", inputId(name))))
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString("\"")
		...
		// StringExpression
		_, err = templBuffer.WriteString(templ.EscapeString(message))
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString("</p>")
...
func StringInput(s sebastion.Input, def, e string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		templBuffer, templIsBuffer := w.(*bytes.Buffer)
		if !templIsBuffer {
			templBuffer = new(bytes.Buffer)
		...
		_, err = templBuffer.WriteString(templ.EscapeString(def))
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString("\"")
...
func IntInput(s sebastion.Input, def, e string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		templBuffer, templIsBuffer := w.(*bytes.Buffer)
		if !templIsBuffer {
			templBuffer = new(bytes.Buffer)
		...
		// Element Attributes
		_, err = templBuffer.WriteString(" id=\"validation\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(">")
...
func BoolInput(s sebastion.Input,def, e string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		templBuffer, templIsBuffer := w.(*bytes.Buffer)
		if !templIsBuffer {
			templBuffer = new(bytes.Buffer)
...
func MultiStringInput(s sebastion.Input,def, e string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		templBuffer, templIsBuffer := w.(*bytes.Buffer)
		if !templIsBuffer {
			templBuffer = new(bytes.Buffer)
